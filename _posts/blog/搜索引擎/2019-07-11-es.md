...
修复后的节点也不再是 primary shard，而是 replica shard。  
<br/>
...
里面标识着这个 commit point 对应的所有 segment file。最后清空 现有 translog 日志文件，重启一个 translog，此时 commit 操作完成。  
<br/>
